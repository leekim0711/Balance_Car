...
/*-- For theta calculation -------------------------------------------------------------------------------------------*/
 ...
 /*-- For controller -------------------------------------------------------------------------------------------*/
 float Vs,Vs_R,Vs_L,Vs_phi,Vs_theR,Vs_the,Vs_theL,V_pwmR,V_pwmL,V_pwm;
 //For turn 90 degree deisire theta should be 480
 float desire_theR=0;
 float desire_theL=0;
 float desire_the=0;
 float desire_phi=0;
 float err_phi,err_theR,err_theL,err_the;
 PIDController pid_phi,pid_the;
 //float Kp_the = 20, Ki_the = 0, Kd_the = 5;
 float Kp_the = 0.25, Ki_the = 0, Kd_the = 0.05;
 int moveMode = 0;//0 for straight, 1 for turn around
 float att[2];
 float the;
 void exam();
 ...
 float sat_turn = 5, sat_line = 1;

 char Kp_buf[10],Ki_buf[10],Kd_buf[10];
 int delimeter_flag = 1;
